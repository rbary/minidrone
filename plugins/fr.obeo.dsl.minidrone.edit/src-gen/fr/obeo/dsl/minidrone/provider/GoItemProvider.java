...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.minidrone.Go} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class GoItemProvider extends InstructionItemProvider {
    /**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Go_distance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Go_distance_feature", "_UI_Go_type"),
				 MiniDronePackage.Literals.GO__DISTANCE,
				 true,
				 false,
				 false,
    ...
    public String getText(Object object) {
		Go go = (Go)object;
		return getString("_UI_Go_type") + " " + go.getDistance();
	}
