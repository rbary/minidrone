 ...
 * @generated
 */
public class MiniDroneProgramItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MiniDroneProgram_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MiniDroneProgram_name_feature", "_UI_MiniDroneProgram_type"),
				 MiniDronePackage.Literals.MINI_DRONE_PROGRAM__NAME,
				 true,
				 false,
				 false,
    ...
    public String getText(Object object) {
		String label = ((MiniDroneProgram)object).getName();
		...
		newChildDescriptors.add
			(createChildParameter
				(MiniDronePackage.Literals.MINI_DRONE_PROGRAM__INSTRUCTIONS,
				 MiniDroneFactory.eINSTANCE.createGo()));
