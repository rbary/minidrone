...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.minidrone.Volume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VolumeItemProvider extends AbstractInstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_percentage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_percentage_feature", "_UI_Volume_type"),
				 MiniDronePackage.Literals.VOLUME__PERCENTAGE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Volume_type") + " " + volume.getPercentage();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Volume.class)) {
			case MiniDronePackage.VOLUME__PERCENTAGE:
