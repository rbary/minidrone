...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.minidrone.Animation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnimationItemProvider extends AbstractInstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Animation_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Animation_mode_feature", "_UI_Animation_type"),
				 MiniDronePackage.Literals.ANIMATION__MODE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		AnimationMode labelValue = ((Animation)object).getMode();
