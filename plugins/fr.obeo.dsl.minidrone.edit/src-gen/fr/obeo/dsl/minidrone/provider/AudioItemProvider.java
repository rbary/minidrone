...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.minidrone.Audio} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AudioItemProvider extends AbstractInstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Audio_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Audio_mode_feature", "_UI_Audio_type"),
				 MiniDronePackage.Literals.AUDIO__MODE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		AudioMode labelValue = ((Audio)object).getMode();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Audio.class)) {
			case MiniDronePackage.AUDIO__MODE:
