 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.minidrone.impl.AudioImpl#getMode <em>Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AudioImpl extends InstructionImpl implements Audio {
	 ...
	 * @ordered
	 */
	protected static final AudioMode MODE_EDEFAULT = AudioMode.MONSTER;
	...
	protected EClass eStaticClass() {
		return MiniDronePackage.Literals.AUDIO;
	}
	...
	public void setMode(AudioMode newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniDronePackage.AUDIO__MODE, oldMode, mode));
	}
