 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.minidrone.impl.VolumeImpl#getPercentage <em>Percentage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VolumeImpl extends AbstractInstructionImpl implements Volume {
	...
	protected EClass eStaticClass() {
		return MiniDronePackage.Literals.VOLUME;
	}
	...
	public void setPercentage(int newPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniDronePackage.VOLUME__PERCENTAGE, oldPercentage, percentage));
	}
