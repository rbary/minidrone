 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.minidrone.impl.BooleanExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanExpressionImpl extends MinimalEObjectImpl.Container implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return MiniDronePackage.Literals.BOOLEAN_EXPRESSION;
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniDronePackage.BOOLEAN_EXPRESSION__EXPRESSION, oldExpression, expression));
	}
